...
fun AddStudentScreen(
    ...
    var selectedBatchId by remember { mutableStateOf(batchId ?: "") }
            ...
            Column {
                ...
                Box {
                    ...
                    DropdownMenu(
                        ...
                        if (batches.isEmpty()) {
                            DropdownMenuItem(
                                text = { Text("No batches available. Create one first.") },
                                onClick = { showBatchDropdown = false },
                                enabled = false
                            )
                        } else {
            ...
            Column {
                ...
                Card(
                    ...
                    Row(
                        ...
                        Text(
                            text = if (selectedBatch != null) "Change" else "Select batch first",
                            style = MaterialTheme.typography.labelLarge,
                            color = if (selectedBatch != null) 
